...
public abstract class AbstractStudent implements java.io.Serializable {
	...
	/** minimal constructor */
	public AbstractStudent(String id, String name, String major,
	...
	/** full constructor */
	public AbstractStudent(String id, String name, String major,
			String username, String password, String address, String sex,
			Date birthday, String email, String grade, String college,
			String telephone, String photo, String description, Set studentjobs) {
		this.id = id;
		this.name = name;
		this.major = major;
		this.username = username;
